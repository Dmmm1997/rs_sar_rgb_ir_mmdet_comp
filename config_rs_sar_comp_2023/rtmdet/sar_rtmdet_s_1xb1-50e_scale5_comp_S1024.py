_base_ = [
    ...
    '../_base_/datasets/2023_rs_sar_comp.py', 
    './rtmdet_tta.py'
]
...
val_dataloader = dict(
    batch_size=2, num_workers=8, dataset=dict(pipeline=test_pipeline))
test_dataloader = val_dataloader

max_epochs = 50
stage2_num_epochs = 45
base_lr = 0.002/16
interval = 1
...
load_from = "work_dirs/sar_rtmdet_s_1xb4-100e_scale5_comp_switch10/epoch_64.pth"
